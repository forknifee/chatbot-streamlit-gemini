...
from utils import (gen_file_name, get_answer, image_detection, speech_to_text,
                   stream_data, text_to_speech, translations)
...
if st.session_state.audio or prompt or st.session_state.upload:
    if st.session_state.audio:
        ...
        if image:
            ...
            crop_name, disease_name, prevention = image_detection(file_path)
            response = f"{crop_name} | {disease_name} | {prevention}"
            st.session_state.messages.append(
